...
public class TeacherOperationTakePhoto extends AppCompatActivity {
    ...
    private void returnButton() {
        returnButton.setOnClickListener(Utils.setReturnButton(TeacherOperationTakePhoto.this));
    }
    ...
    private void openCamera() {
        ...
        intent.setClass(TeacherOperationTakePhoto.this, CameraCapture.class);
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(TeacherOperationTakePhoto.this);
